                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 text-gray-700">
                  ...
                  {job.match_score && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span>
                        Match Score: <strong>{job.match_score < 70 ? Math.max(0, job.match_score - (job.match_score * 0.1)).toFixed(0) : job.match_score}%</strong>
                      </span>
                    </div>
                  )}
                  {job.is_recommended && (
                        ...
                        <div className="flex items-center text-xs text-gray-500 space-x-3">
                          ...
                          {similarJob.match_score && (
                            <span className="flex items-center">
                              ...
                              {similarJob.match_score < 70 ? Math.max(0, similarJob.match_score - (similarJob.match_score * 0.1)).toFixed(0) : similarJob.match_score}% match
                            </span>
                          )}
                        </div>
                      </div>
